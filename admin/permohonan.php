			...
			<div class="col-lg-12">
				...
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						<p class="alert alert-info">Klik tombol catatan untuk membuat catatan cuti dari admin (Sisa cuti dan lain-lain).</p>
						<div class="datatable-scroll">
							<table class="table table-bordered table-hover table-striped" id="table-datatable">
								...
								<tbody>
									<?php
									$no = 1; 
									$data = mysqli_query($koneksi,"(select * from permohonan order by permohonan_id desc)");		
									while($d=mysqli_fetch_array($data)){
										...
										<tr>								
											...
											<td>	
												...
												<!-- <?php } ?>  -->
												<a class="btn btn-primary btn-icon btn-xs" href="permohonan_catatan.php?id=<?php echo $d['permohonan_id'];?>">CATATAN</a>		
											</td>
										</tr>
										<?php
									}
