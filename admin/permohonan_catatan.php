					...
					<div class="panel-body">
						<div class="table-responsive">
							...
							while($d=mysqli_fetch_array($data)){
								?>
								<form action="permohonan_catatan_act.php" method="post">
									<table class="table">	
										<tr>
										...
										<tr>
											<th>Catatan Admin</th>
											<td><textarea class="form-control" name="cat_admin"><?php echo $d['cat_admin']; ?></textarea></td>
										</tr>
										<tr>
											<th>Catatan Sisa Cuti</th>
											<td><textarea class="form-control" name="cat_sisa_cuti"><?php echo $d['cat_sisa_cuti']; ?></textarea></td>
										</tr>
										<tr>
											<th>Catatan Pertimbangan</th>
											<td><textarea class="form-control" name="cat_pertimbangan"><?php echo $d['cat_pertimbangan']; ?></textarea></td>
										</tr>								
										<tr>
											<th></th>
