...
<head>
	...
	<?php 
	session_start();
	if($_SESSION['status'] != "superadmin_login"){
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="admin.php"><i class="icon-user-plus"></i> <span>Data Admin</span></a></li>						
								<li><a href="ketua.php"><i class="icon-user-plus"></i> <span>Data Ketua</span></a></li>						
								<li><a href="pegawai.php"><i class="icon-user-plus"></i> <span>Data Pegawai</span></a></li>
								<!-- <li><a href="cuti.php"><i class="icon-stack2"></i> <span>Data Pegawai Cuti</span></a></li>								 -->
