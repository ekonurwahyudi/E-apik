			...
			<div class="col-lg-8 col-md-offset-2">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h4 class="panel-title">Tambah Data ketua</h4>
						<div class="heading-elements">
							<a href="ketua.php" class="btn btn-sm btn-primary"><i class="icon-arrow-left12"></i> KEMBALI</a>
						</div>
					</div>
					<div class="panel-body">
						<div class="table-responsive">
							<?php
							$id = $_GET['id'];
							$data = mysqli_query($koneksi,"select * from ketua where id='$id'");
							while($d=mysqli_fetch_array($data)){
								?>
								<form action="ketua_update.php" method="post">									
									<table class="table">
										<tr>
											<th>Nama</th>
										...
										<tr>
											<th>Ketua (PN atau PT)</th>
											<td>
												<select name="ketua" class="form-control" required="required">
													<option value=""> - PILIH - </option>
													<option <?php if($d['jenis_ketua']=="PN"){echo "selected='selected'";} ?> value="PN">PN</option>
													<option <?php if($d['jenis_ketua']=="PT"){echo "selected='selected'";} ?> value="PT">PT</option>
												</select>
											</td>
										</tr>
										<tr>
