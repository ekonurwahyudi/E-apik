...
<head>
	...
	<?php 
	session_start();
	if($_SESSION['status'] != "ketua_login"){
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<div class="text-size-mini text-muted">
										KETUA <?php echo $_SESSION['jenis_ketua']; ?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								if($_SESSION['jenis_ketua']=="PN"){
									...
									<!-- <li class="">
										...
										<ul class="hidden-ul" style="display: none;">
											<li><a href="permohonan.php"><span>Permohonan Cuti</span></a></li>																			
										</ul>
									</li> -->
									<li><a href="ijin.php"><i class="icon-stack2"></i><span>Permohonan Izin Keluar</span></a></li>	
									<?php
								}
								?>														
								...
								<?php 
								// jika yg login adalah ketua pn
								if($_SESSION['jenis_ketua']=="PT"){
									?>											
									<!-- li><a href="catatan_permohonan.php"><i class="icon-stack2"></i> <span>Cat. Permohonan Cuti Ketua PN</span></a></li>		 -->						
									<li><a href="catatan_ijin_ketua.php"><i class="icon-stack2"></i> <span>Cat. Permohonan Izin Ketua PN</span></a></li>								
									<?php
								}else{
									?>	
									<!-- <li><a href="catatan_permohonan.php"><i class="icon-stack2"></i> <span>Catatan Permohonan Cuti</span></a></li>		-->						
									<li><a href="catatan_ijin.php"><i class="icon-stack2"></i> <span>Catatan Izin Keluar</span></a></li>								
									<?php 
								}
								?>								
